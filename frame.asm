...
Main proc    
        ...
        push FRAME_ATTRIBUTE                    ; Передаем атрибут рамки в функцию
        push SYMBOL_ATTRIBUTE                   ; Передаем атрибут символа в функцию
...
DrawPicture proc
        ...
        push bx                                 ; Передаем указатель на буфер в функцию
        push [bp + 6]                           ; Передаем атрибут символа в функцию
        call PrintText

        xor ax, ax
        mov al, [bx + 1]                        ; Записываем длину записанной в буфер строки

        push [bp + 8]                           ; Передаем атрибут символа рамки
        push ax
        call PrintFrame
...
PrintText proc
        ...
        mov dx, [bp + 4]                        ; Загружаем атрибут символа
...
PrintFrame proc
        ...
        mov si, [bp + 6]                        ; Загружаем атрибут символа рамки
